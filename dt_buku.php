...
<ul class="sidebar-nav" id="sidebar-nav">
  ...
  <li class="nav-item">
    <a class="nav-link" href="dt_buku.php?page=daftar-data">
  ...
  ?>
              ...
              <div class="card recent-sales overflow-auto">
                <div class="card-body">
                  ...
                  <table class="table table-borderless datatable">
                    ...
                    <?php
                      $no = 1;
                      $data_array = $buku->tampil_semua_data();
                    ...
                    ?>  <tr>
                        ...
                        <td><?=$r->tahun?></td>
                        <td><?=$r->penerbit?></td>
                        <td><a href="?page=ubah-buku&id_buku=<?=$r->id_buku?>" class="bi bi-pencil-square">  </a>
                        <a href="proses.php?aksi=hapus-buku&id_buku=<?=$r->id_buku?>" onclick="return confirm('Apakah Anda ingin menghapus data ini?')" class="bi bi-trash"></a></td>
                      </tr>
                    <?php $no++;
                      }
    ...
    <?php } else if ($_GET['page']=='ubah-buku') {
			$r = $buku->tampil_data($_GET['id_buku']);
		?>
        ...
        <div class="col-lg-7">
          <div class="card">
            <div class="card-body">
              ...
              <input type="hidden" name="aksi" value="ubah-buku"/>
              <input type="hidden" name="id_buku" value="<?=$r->id_buku?>"/>
                <div class="col-12">
                  <label for="inputNanme4" class="form-label">ID Buku</label>
                  <input type="text" disabled name="id_buku" class="form-control" value="<?=$r->id_buku?>" id="inputNanme4">
                </div>
                <div class="col-12">
                  <label for="inputNanme4" class="form-label">Judul Buku</label>
                  <input type="text" name="judul_buku" class="form-control" id="inputNanme4" value="<?=$r->judul_buku?>">
                </div>
                <div class="col-12">
                  <label for="inputNanme4" class="form-label">Penulis</label>
                  <input type="tel" name="penulis" class="form-control" id="inputNanme4" value="<?=$r->penulis?>">
                </div>
                <div class="col-12">
                  <label for="inputNanme4" class="form-label">Tahun</label>
                  <input type="tel" name="tahun" class="form-control" id="inputNanme4" value="<?=$r->tahun?>">
                </div>
                <div class="col-12">
                  <label for="inputNanme4" class="form-label">Penerbit</label>
                  <input type="tel" name="penerbit" class="form-control" id="inputNanme4" value="<?=$r->penerbit?>">
                </div>
