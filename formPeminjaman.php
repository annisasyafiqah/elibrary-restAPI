...
<ul class="sidebar-nav" id="sidebar-nav">
  ...
  <li class="nav-item">
    <a class="nav-link" href="formPeminjaman.php">
      <i class="bi bi-file-earmark-person"></i>
          ...
          <div class="card">
            <div class="card-body">
              ...
              <form class="row g-3" name="form" method="POST" action="proses.php">
                <input type="hidden" name="aksi" value="tambah-peminjaman"/>
                <div class="col-12">
                  ...
                  <select class="form-select" name="id_anggota" aria-label="Default select example">
                      ...
                      <?php 	$data_array = $anggota->tampil_semua_data();
                        foreach ($data_array as $r) { ?>	
                            <option value="<?=$r->id_anggota?>"> <?=$r->nama_anggota?> </option>
                        <?php }
                        unset($data_array,$r);
                      ?>
                    </select>
                ...
                <div class="col-12">
                  ...
                  <option>Pilih Judul buku </option>
                    <?php 	$data_array = $buku->tampil_semua_data();
                      foreach ($data_array as $r) { ?>	
                          <option value="<?=$r->id_buku?>"> <?=$r->judul_buku?> </option>
                      <?php }
                      unset($data_array,$r);
                    ?>
                  </select>
                ...
                <div class="col-12">
                  <label for="inputNanme4" class="form-label">Tanggal Peminjaman</label>
                  <input type="text" name="tgl_pinjam"class="form-control" id="inputNanme4">
                </div>
                <div class="col-12">
                  <label for="inputNanme4" class="form-label">Tanggal Pengembalian</label>
                  <input type="text" name="tgl_kembali" class="form-control" id="inputNanme4">
                </div>
