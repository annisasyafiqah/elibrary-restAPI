...
<ul class="sidebar-nav" id="sidebar-nav">
  ...
  <li class="nav-item">
    <a class="nav-link" href="formAnggota.php">
            ...
            <div class="card-body">
              ...
              <input type="hidden" name="aksi" value="tambah"/>
                <div class="col-12">
                  ...
                  <input type="text" name="nama_anggota" class="form-control" id="inputNanme4">
                </div>
                <div class="col-12">
                  <label for="inputNanme4" class="form-label">Nomor HP</label>
                  <input type="tel" class="form-control" name="no_hp" id="inputNanme4">
                </div>
                <div class="col-12">
